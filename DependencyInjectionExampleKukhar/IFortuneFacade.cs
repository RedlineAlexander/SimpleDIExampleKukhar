...
namespace SimpleDIExampleKukhar.DependencyInjectionExampleKukhar
{
    ...
    public interface IFortuneFacade
    {
      ...
      //  IFortuneLoader fortuneLoader { get; set; }
       ...
       // public IFortuneLoader GoodLoader()
      //  {
      //      
      //  }
       // public IFortuneGetter GoodGetter()
       // {
//
      //  }
        //public IFortuneLoader GoodTellLoader(IFortuneGetter fortuneGetter);
    //    public IFortuneGetter GoodTellGetter(IFortuneLoader fortuneLoader);

        //IFortuneHeader IFortuneTeller
